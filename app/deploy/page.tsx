...
const steps: {
  ...
  {
    name: "Crea tu propio EncriptArchiver",
    description: "Crea tu versión de EncriptArchiver totalmente personalizada apartir de mi repositorio.",
    cta: (
      <Link
...
export default function Deploy() {
  return (
    <div className="container px-8 mx-auto mt-16 lg:mt-32 ">
      <Title>Crea tu versión de EncriptArchiver</Title>
      <p className="mt-4 text-sm text-center text-zinc-600">
        Solo necesitas una database Uptash y Vercel.
      </p>
