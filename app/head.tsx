export default function Head({ title, subtitle }: { title: string; subtitle: string }) {
  // Fallback tagline
  title ??= "EncriptArchiver: Encripta todo tipo de archivos con AES-GCM";
  subtitle ??= "Encripta documentos que necesites compartir para tener más control del mismo.";
  ...
  return (
    <>
      <title>EncriptArchiver; Encripta todo tipo de archivos con AES-GCM</title>
