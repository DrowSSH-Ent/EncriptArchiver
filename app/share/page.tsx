    ...
    <div className="container px-8 mx-auto mt-16 lg:mt-32 ">
      ...
      {link ? (
        <div className="flex flex-col items-center justify-center w-full h-full mt-8 md:mt-16 xl:mt-32">
          <Title>Comparte tu enlace.</Title>
        ...
        >
          ...
          <pre className="px-4 py-3 mt-8 font-mono text-left bg-transparent border rounded border-zinc-600 focus:border-zinc-100/80 focus:ring-0 sm:text-sm text-zinc-100">
            <div className="flex items-start px-1 text-sm">
              ...
              <textarea
                ...
                placeholder="Notas, Documentos, contraseñas, archivos, cuentas, tarjetas, recibos, TODO LO QUE QUIERAS MANTENER SEGURO Y NECESITES COMPARTIRLO A UN TERCERO."
          ...
          <div className="mt-8">
            <ul className="space-y-2 text-xs text-zinc-500">
              <li>
                <p>
                  <span className="font-semibold text-zinc-400">Reads:</span> El número de vistas son las veces que el archivo encriptado requiera ser visto, ejemplo, si compartes una contraseña, pon 1 para que la otra persona, solo pueda acceder a ella una sola vez. <br> PD. Si pones 0, las vistas son ilimitadas.                 </p>
              </li>
              <li>
                <p>
                  <span className="font-semibold text-zinc-400">TTL:</span> TTL se refiere al tiempo de vida del enlace, 7 días,  1 hora, 5 minutos, 2 años.
                </p>
              </li>
              <p>
                El protocolo de seguridad se basa en AES-GCM, de las más seguras.
