    ...
    <div className="flex flex-col gap-8 pb-8 md:gap-16 md:pb-16 xl:pb-24">
      <div className="flex flex-col items-center justify-center max-w-3xl px-8 mx-auto mt-8 sm:min-h-screen sm:mt-0 sm:px-0">
        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
          ...
          >
            EncriptArchiver es de código abierto{" "}
        ...
        <div>
          <h1 className="py-4 text-5xl font-bold tracking-tight text-center text-transparent bg-gradient-to-t bg-clip-text from-zinc-100/50 to-white sm:text-7xl">
            EncriptArchiver: Encriptador web de archivos.
          </h1>
          <p className="mt-6 leading-5 text-zinc-600 sm:text-center">
            EncriptArchiver es un encriptador online similar a una nube pues puedes guardar notas, archivos,  documentos, imágenes, videos, música etc y compartir los mismos mediante un enlace con protocolo AES-GCM para una mayor seguridad de tus datos. By DrowKid
          </p>
      ...
      <h2 className="py-4 text-3xl font-bold text-center text-zinc-300 ">EncriptArchiver es de código abierto, por ende, cualquier usuario puede crear su versión apartir de la estructura de EncriptArchiver by DrowKid</h2>
      <Stats />
      <Testimonials />
    </div>
  );
